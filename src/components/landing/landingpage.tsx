...
import { AspectRatio, Badge, Container, Flex, Grid, SimpleGrid, Stack, Text, useMantineTheme } from "@mantine/core";
        ...
        <Grid>
          ...
          <Stack>
            ...
            <Text size="xl" fw={300} variant="gradient" gradient={{ from: "white", to: "white", deg: 90 }}>
              ...
              appreciate you hustlers, dreamers, and visionaries. Who dare to take responsibly the biggest leap of faith in life; to decide
