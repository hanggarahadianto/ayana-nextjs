          ...
          >
            <Group justify="space-between" mt="md" mb="xs">
              ...
              <Text
                ...
                size="xl"
                mt={40}
                style={{ fontFamily: "Lora", fontSize: "1.5rem" }}
              >
                Tinggal di Ayana sangat nyaman, dari udara yang sejuk, fasilitas
                yang lengkap, kemana mana dekat, dan pastinya rumahnya tidak ada
                masalah
              </Text>
            </Group>
        ...
        <Grid.Col span={8} bg={"#486245"} h={"85vh"}>
          <Stack ml={300} align="start" justify="center" mt={120} gap={1}>
            ...
            <Text
              ...
              fw={800}
              c="#a67d67"
              style={{ fontFamily: "Montserrat", fontSize: "4rem" }}
            >
              AYANA HOME
            </Text>
            <Text
              ...
              style={{ fontFamily: "Lora", fontSize: "1.5rem" }}
            >
              Find out more about Cendana Homes from the customers and
              residents.
            </Text>
          </Stack>
        </Grid.Col>
          ...
          <Marquee speed={100}>
            <Group mt={80}>
              <Text
                ...
                fw={900}
                c={"white"}
                style={{ fontFamily: "Montserrat", fontSize: "7rem" }}
              >
